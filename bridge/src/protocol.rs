...
impl Persona {
    ...
    pub fn from_ack_flags(flags: u8) -> Self {
        if flags & ACK_FLAG_N64_USBC_PERSONA == ACK_FLAG_N64_USBC_PERSONA {
            ...
            Persona::Keyboard
        } else if flags & ACK_FLAG_N64_PERSONA == ACK_FLAG_N64_PERSONA {
            Persona::N64
...
mod tests {
    ...
    fn persona_from_ack_flags() {
        ...
        assert_eq!(Persona::from_ack_flags(ACK_FLAG_N64_PERSONA), Persona::N64);
        assert_eq!(
            Persona::from_ack_flags(ACK_FLAG_N64_PERSONA | ACK_FLAG_USB_DIAG_SUPPORTED),
            Persona::N64
        );
        assert_eq!(
