...
typedef enum {
    ...
    RUN_PERSONA_BT_HID = 8,      // Bluetooth generic HID gamepad
    RUN_PERSONA_BT_XBOX = 9,     // Bluetooth Xbox Wireless Controller
    RUN_PERSONA_BT_PS = 10,      // Bluetooth DualShock 4 / Wireless Controller
} run_persona_t;
